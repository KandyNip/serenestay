...
export const DNA_QUESTIONS: DNAQuestion[] = [
  {
    ...
    options: [
      { emoji: "coffee", label: "Silent coffee & journal", sublabel: "→ Serenity ↑↑", weights: { serenity: 3, wellness: 1 } },
      { emoji: "flower-2", label: "Sunrise yoga session", sublabel: "→ Wellness ↑↑", weights: { wellness: 3, serenity: 1 } },
      { emoji: "heart", label: "Brunch with friends", sublabel: "→ Community ↑ Culture ↑", weights: { community: 2, nature: 1 } },
      { emoji: "tree-pine", label: "Hike into the hills", sublabel: "→ Nature ↑↑", weights: { nature: 3, climate: 1 } },
    ],
  },
  {
    id: 2,
    ...
    options: [
      { emoji: "sunset", label: "Watching the sunset alone", sublabel: "→ Serenity ↑ Affordability ↑", weights: { serenity: 2, affordability: 1 } },
      { emoji: "wind", label: "Live music & local culture", sublabel: "→ Community ↑ Culture ↑", weights: { community: 2, wellness: 1 } },
      { emoji: "droplets", label: "Spa & early sleep", sublabel: "→ Wellness ↑↑", weights: { wellness: 3, medical: 1 } },
      { emoji: "moon", label: "Stargazing far from city", sublabel: "→ Nature ↑ Serenity ↑", weights: { nature: 2, serenity: 1 } },
    ],
  },
  {
    id: 3,
    ...
    options: [
      { emoji: "wifi", label: "No reliable WiFi", sublabel: "→ WiFi ↑↑", weights: { wifi: 3 } },
      { emoji: "coins", label: "Running out of money", sublabel: "→ Affordability ↑↑", weights: { affordability: 3 } },
      { emoji: "heart-pulse", label: "Feeling medically unsafe", sublabel: "→ Medical ↑↑", weights: { medical: 3 } },
      { emoji: "volume-x", label: "Too noisy & crowded", sublabel: "→ Serenity ↑↑", weights: { serenity: 3 } },
    ],
  },
  {
    id: 4,
    ...
    options: [
      { emoji: "flower-2", label: "Deep healing & recovery", sublabel: "→ Wellness ↑ Serenity ↑", weights: { wellness: 2, serenity: 1 } },
      { emoji: "leaf", label: "Immersing in nature", sublabel: "→ Nature ↑↑ Climate ↑", weights: { nature: 2, climate: 1 } },
      { emoji: "heart", label: "Meeting like-minded people", sublabel: "→ Community ↑↑", weights: { community: 3 } },
      { emoji: "plane", label: "Easy visa & affordable", sublabel: "→ Visa ↑ Affordability ↑", weights: { visa: 2, affordability: 1 } },
    ],
  },
  {
    id: 5,
    ...
    options: [
      { emoji: "waves", label: "By the ocean", sublabel: "→ Nature ↑ Serenity ↑", weights: { nature: 2, serenity: 1 } },
      { emoji: "mountain", label: "In the mountains", sublabel: "→ Nature ↑ Climate ↑", weights: { nature: 1, climate: 2 } },
      { emoji: "heart", label: "In spiritual practice", sublabel: "→ Wellness ↑↑ Serenity ↑", weights: { wellness: 2, serenity: 1 } },
      { emoji: "home", label: "In a cozy home base", sublabel: "→ WiFi ↑ Affordability ↑", weights: { wifi: 1, affordability: 1, medical: 1 } },
    ],
  },
];
