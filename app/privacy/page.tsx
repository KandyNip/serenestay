      ...
      <div className="container-full px-4 py-16 max-w-3xl mx-auto">
        ...
        <div className="space-y-6 text-primary/80 leading-relaxed">
          ...
          <section>
            ...
            <p>We use AI services to power our chat recommendations. These services process your messages to generate responses. We do not control their data retention practices — please review their privacy policy for details.</p>
